      ...
      <main className="max-w-4xl mx-auto px-6 pt-36 pb-24 text-center">
        ...
        >
          ...
          <p className="text-lg text-[var(--hb-ink-soft)] max-w-2xl mx-auto leading-relaxed">
            Our mission is to empower healthcare providers with cutting-edge artificial
            intelligence, streamlining clinical administration so doctors can focus on what matters
            most: patient care.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
            <div className="glass-clay p-8 text-left space-y-4">
              ...
              <p className="text-sm text-[var(--hb-ink-soft)] leading-relaxed">
                A connected healthcare ecosystem where technology bridges the gap between diagnosis
                and recovery instantly.
              </p>
            </div>
            <div className="glass-clay p-8 text-left space-y-4">
