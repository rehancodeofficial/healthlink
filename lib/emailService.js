...
async function sendOTPViaSendGrid(email, otp) {
  const msg = {
    to: email,
    from: FROM_EMAIL,
    subject: "Email Verification - Health Bridge",
    text: `Your verification code is: ${otp}\n\nThis code will expire in 5 minutes.\n\nIf you didn't request this code, please ignore this email.`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <h2 style="color: #4F46E5;">Email Verification</h2>
        <p>Thank you for registering with Health Bridge!</p>
        ...
        <p style="color: #9CA3AF; font-size: 12px; text-align: center;">Health Bridge - Your Health, Our Priority</p>
      </div>
    `,
  };
...
async function sendOTPViaGmail(email, otp) {
  ...
  const mailOptions = {
    from: `"Health Bridge" <${RESOLVED_EMAIL_USER}>`, // ✅ Must match authenticated Gmail account
    to: email,
    subject: "Email Verification - Health Bridge",
    text: `Your verification code is: ${otp}\n\nThis code will expire in 5 minutes.\n\nIf you didn't request this code, please ignore this email.`,
    html: `
